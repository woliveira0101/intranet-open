...
@view_config(route_name='times_report_current_pivot', permission='can_see_users_times')
...
@view_config(route_name='times_report_pivot', permission='can_see_users_times')
