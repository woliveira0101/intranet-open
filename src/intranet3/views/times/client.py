...
@view_config(route_name='times_client_report', permission='times_reports')
...
@view_config(route_name='times_client_per_client_per_employee_excel', permission='times_reports')
...
@view_config(route_name='times_client_current_pivot', permission='times_reports')
...
@view_config(route_name='times_client_pivot', permission='times_reports')
