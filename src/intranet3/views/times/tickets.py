...
@view_config(route_name='times_tickets_excel', permission='can_view_times_reports')
...
@view_config(route_name='times_tickets_titles', renderer='json', permission='can_view_times_reports')
...
@view_config(route_name='times_tickets_report', permission='can_view_times_reports')
